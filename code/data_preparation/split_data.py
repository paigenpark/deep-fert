...
with open("../../data/asfr/asfrRR.txt", "r") as file:
...
asfr_period_data = np.array(data)
print("ASFR data shape:", asfr_period_data.shape)
...
np.savetxt('../../data/asfr_training.txt', asfr_training)
print("ASFR training data shape:", asfr_training.shape)

test_index = np.logical_and(asfr_period_data[:, 1] > 2005, asfr_period_data[:, 1] <= 2015)
asfr_test = asfr_period_data[test_index, :]
np.savetxt('../../data/asfr_test.txt', asfr_test)
print("ASFR test data shape:", asfr_test.shape)

final_test_index = np.logical_and(asfr_period_data[:, 1] > 2015, asfr_period_data[:, 1] <= 2019)
